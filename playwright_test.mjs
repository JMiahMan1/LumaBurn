...
(async () => {
  ...
  try {
    ...
    const rectNodeValid = await page.evaluate(() => {
        ...
        return rect.scaleX !== undefined && rect.scaleY !== undefined && rect.scale === undefined && rect.operationLayerId !== null;
    });
    ...
    await page.waitForFunction(() => window.LumaState.objects.length === 1 && window.LumaState.objects[0].type === "group");
